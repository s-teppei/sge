...
import xyz.sizuma.sge.entity.attribute.{AutoUpdate, HasAutoUpdater, HasSelfState, HasUpdater}
...
/**
  ...
  */
class RandomColorEntity(override val timer:Timer = new Timer(),override val delay:Int = 0,override val interval:Int = 1000) extends Entity[Color] with HasAutoUpdater[Color] with HasSelfState[Color]{
